...
export class Settings {
    ...
    // public static readonly AJAX_URL: string ="http://192.168.0.101:8080";
    public static readonly AJAX_URL: string ="http://47.104.136.74:8081";
    ...
    public static readonly SECONDARY_COLOR: string = "#a09efd";
